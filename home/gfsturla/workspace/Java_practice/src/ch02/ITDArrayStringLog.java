...
public class ITDArrayStringLog
{
  ...
  { 
    ...
    while (keepGoing)
    {
      ...
      System.out.println("10: howMany()");
      System.out.println("11: uniqInsert()");
      ...
      switch (operation)
      {
        ...
        String searchElement = conIn.next();
        System.out.println("Result: " + test.howMany(searchElement));
        break;
        
        
        case 11:
        System.out.println("Enter Unique String");
        String uniqString = conIn.next();
        System.out.println("Result: " + test.uniqInsert(uniqString));
        break;
        
        case 12:
        	System.out.println("Enter String");
        	String delete = conIn.next();
        	System.out.println("Result: " + test.delete(delete));
        	break;
        	
        case 13:
        	System.out.println("Enter String");
        	String deleteAll = conIn.next();
        	System.out.println("Result: " + test.deleteAll(deleteAll));
        	break;
        
        case 14:
        	
        	System.out.println("Result: " + test.smallest());
        	break;
